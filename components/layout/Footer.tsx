    ...
    <footer className="relative mt-auto border-t border-border-subtle bg-void">
      ...
      <div className="absolute inset-x-0 bottom-full h-16 overflow-hidden pointer-events-none">
        ...
        >
          ...
          {/* Window lights — flickering at different speeds */}
          <rect x="122" y="12" width="2" height="3" fill="var(--amber)" className="animate-flicker-slow" />
          <rect x="126" y="18" width="2" height="3" fill="var(--amber)" className="animate-flicker-medium" style={{ animationDelay: "0.7s" }} />
          <rect x="132" y="12" width="2" height="3" fill="var(--amber)" className="animate-flicker-slow" style={{ animationDelay: "1.2s" }} />
